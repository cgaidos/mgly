...
function main()
{
	...
	print ("\n ---------- Nofifications Livrable ----------- \n");
	print_r ($paramsLivrable);
	...
	print ("\n ---------- Nofifications Staffing ----------- \n");
	print_r ($paramsStaffing);
	...
	print ("\n ---------- Nofifications Pointage ----------- \n");
	print_r ($paramsPointage);
	...
	print ("\n ---------- Nofifications validation pointage ----------- \n");
	print_r ($paramsPointage);
	foreach ($paramsPointage as $parameters){
		Notif::postNotification ($parameters);
	}
	...
	print ("\n ---------- Nofifications Planning ----------- \n");
	print_r ($paramsProjet);
...
function getParamsPlanning ()
{
	...
	foreach ($nodes as $node) {
		...
		$projetDiff = $planningController->calcDiffPhase($projet_id, array(), true);
